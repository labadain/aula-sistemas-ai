...
| 4ª | Algoritmia peskiza. | Fó koñese ba estudante sira kona-ba proble-solving liuhosi search no introdús algoritmia klásika sira hanesan Breadth-First Search (BFS), Depth-First Search (DFS), no A* search algorithm (intuition only).  | Estudante sira iha kapasidade atu rezolve problema peskiza simples ida liuhosi aplikasaun algoritmia BFS, DFS, no A*. | [🔗](module-1-ai-foundations/week-2/meeting-4.html) |
| 5ª | Fundamentu machine learning (ML) no avaliasaun. | Fó koñese ba estudante sira kona-ba fundamentu ML, pipeline, tipu ML, treinu no avalia modelu ML, no importánsia hosi avaliasaun.  | Estudante sira bele deskreve ML nia pipeline, komprende diferensa hosi aprendizajen supervizionada vs. la'ós supervizionada vs. reinforcement learning, no modelu AI ida-nia komportamentu. | [🔗](module-2-machine-learning/week-3/meeting-5.html) |
| 6ª | Aprendizajen supervizionada. |  |  | [🔗](module-2-machine-learning/week-3/meeting-6.html) |
| 7ª | **Aula prátika:** Treinu no avalia modelu klasifikasaun / previzaun. |  |  | [🔗](module-2-machine-learning/week-4/meeting-7.html) |
